...
st.divider()
st.divider()
# ---------------------------- Define input var directly ----------------------------
input_var1 = st.number_input("var1", min_value = 0.0, max_value = 10000.0, value = 0.0)
input_var2 = st.number_input("var2", min_value = 0.0, max_value = 10000.0, value = 0.0)
input_var3 = st.number_input("var3", min_value = 0.0, max_value = 10000.0, value = 0.0)
sum_explicit_var = input_var1 + input_var2 + input_var3
st.write(f'Sum input var defined directly: {sum_explicit_var}')

# ---------------------------- Define input var with a dictionary in a for ----------------------------
st.divider()
list_var = ['varA', 'varB', 'varC']
dict_var = {}
suma_dict_var = 0
for var_name in list_var:
    dict_var[var_name] = st.number_input(var_name, min_value = 0.0, max_value = 10000.0, value = 0.0)
for var_name in list_var:
    suma_dict_var += dict_var[var_name]
st.write(f'Sum input var defined in a dictionary: {suma_dict_var}')
